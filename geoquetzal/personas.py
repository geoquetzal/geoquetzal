...
VARIABLES = {
    ...
    "PCP13": {"etiqueta": "¿A qué comunidad lingüística pertenece?", "tipo": "étnica"},
    "PCP14": {
        "etiqueta": "¿Utiliza regularmente ropa o traje maya, garífuna, afrodescendiente o xinka?",
        "tipo": "étnica",
        "valores": {1: "Sí", 2: "No"},
    },
    "PCP15": {"etiqueta": "¿Cuál es el idioma en el que aprendió a hablar?", "tipo": "étnica"},
    # --- Disability ---
    ...
    "PCP21": {"etiqueta": "¿Cuál es la causa principal por la que no asiste a un establecimiento educativo?", "tipo": "educación"},
    # --- Literacy ---
    "PCP22": {
    ...
    "PCP23_A": {"etiqueta": "¿En qué idioma sabe leer y escribir? Idioma 1", "tipo": "educación"},
    "PCP23_B": {"etiqueta": "¿En qué idioma sabe leer y escribir? Idioma 2", "tipo": "educación"},
    "PCP23_C": {"etiqueta": "¿En qué idioma sabe leer y escribir? Idioma 3", "tipo": "educación"},
    "PCP24": {
        "etiqueta": "Además del idioma en el que aprendió a hablar, ¿sabe hablar otro idioma?",
        "tipo": "educación",
        "valores": {1: "Sí", 2: "No"},
    },
    "PCP25_A": {"etiqueta": "¿En qué otro idioma sabe hablar? Idioma 1", "tipo": "educación"},
    "PCP25_B": {"etiqueta": "¿En qué otro idioma sabe hablar? Idioma 2", "tipo": "educación"},
    "PCP25_C": {"etiqueta": "¿En qué otro idioma sabe hablar? Idioma 3", "tipo": "educación"},
    # --- Technology ---
    ...
    "PCP28": {"etiqueta": "¿Qué hizo durante la semana pasada:", "tipo": "empleo"},
    "PCP29": {"etiqueta": "Si no trabajó, ¿qué fue lo que hizo durante la semana pasada:", "tipo": "empleo"},
    "PCP30_2D": {"etiqueta": "Ocupación (2 dígitos)", "tipo": "empleo"},
    "PCP30_1D": {"etiqueta": "Ocupación (1 dígito)", "tipo": "empleo"},
    "PCP31_D": {"etiqueta": "Categoría ocupacional", "tipo": "empleo"},
    "PCP32_2D": {"etiqueta": "Actividad económica (2 dígitos)", "tipo": "empleo"},
    "PCP32_1D": {"etiqueta": "Actividad económica (1 dígito)", "tipo": "empleo"},
    ...
    "NIVGRADO": {"etiqueta": "Nivel y grado de estudio", "tipo": "derivada"},
    ...
    "POCUPA": {"etiqueta": "Personas ocupadas", "tipo": "derivada"},
    "PDESOC": {"etiqueta": "Personas desocupadas", "tipo": "derivada"},
